...
public class ProductManager implements ProductService{
	...
	@Override
	public DataResult<List<Product>> getByProductNameStartsWith(String prodctName) {
		return new SuccessDataResult<List<Product>>(this.productDao.getByProductNameStartsWith(prodctName),"Data Listelendi");  
	}
